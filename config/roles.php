...
return [
	...
	*/
	...
	/*
	 ...
	 |--------------------------------------------------------------------------
	 |
	 | These paths are Laravel-only discovery adapters. Core resolvers can still
	 | be used directly in plain PHP by providing explicit model names/subjects.
	 |
	 */
	'discovery' => [
	...
	/*
	 |--------------------------------------------------------------------------
	 | Package Migration Loading
	 |--------------------------------------------------------------------------
	 |
	 | Disable this only if your host app publishes and owns equivalent
	 | permission-manager migrations itself.
	 |
	 */
	'migrations' => [
		'load' => true,
	...
	/*
	 ...
	 |--------------------------------------------------------------------------
	 |
	 | Control localized display names for roles and permissions.
	 |
	 */
	'translate' => [
		'enabled' => true,
