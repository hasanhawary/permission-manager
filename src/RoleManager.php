...
class RoleManager
{
    ...
    {
        $this->createRole(); // Create a basic role and assign all permissions to this role
        ...
        $roles->each(function ($details, $role)  {
            $roleModel = $this->firstOrCreateRole($role);

            $permissions = $this->getRolePermissions($details);
